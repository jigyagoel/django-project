...
class Order(models.Model):
    ...
    shipping_total   = models.DecimalField(default= 500.00 , max_digits=50,decimal_places=2)
    ...
    def update_total(self):
        cart_total = float(format(self.cart.total,'.2f'))
...
def pre_save_create_order_id(sender,instance,*args,**kwargs):
    if not instance.order_id:                                                           ## check if order id is not before
